...
To install and run this project, please follow the [Installation Guide](https://github.com/GUKWAT/dip-programming-prj-advanced-gui-evolve/wiki/Installation)
in the [Wiki](https://github.com/GUKWAT/dip-programming-prj-advanced-gui-evolve/wiki).
...
To contribute to this project, please follow the [Contribution Guide](https://github.com/GUKWAT/dip-programming-prj-advanced-gui-evolve/blob/main/CONTRIBUTING.md)
in the [Wiki](https://github.com/GUKWAT/dip-programming-prj-advanced-gui-evolve/wiki).
